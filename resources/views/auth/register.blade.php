...
<div class="grid md:grid-cols-8">
    <div class="md:flex col-span-5 hidden justify-center items-center bg-blue-900">
        <h1 class="text-white text-xl drop-shadow-xl uppercase font-bold">Welcome to Website Pengantin👋🏻</h1>
    </div>
    <div class="md:col-span-3 flex justify-center px-8 bg-yellow-100">
        ...
        <form class="w-full bg-white shadow-xl rounded px-8 pb-8 mb-5 mt-5 flex flex-col space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="w-full">
                ...
                <input class="shadow border rounded w-full py-2 px-3 text-grey-darker" id="name" type="text" placeholder="nama lengkap" name="name">
                @error('name')
            ...
            <div>
                ...
                <input class="shadow border rounded w-full py-2 px-3 text-grey-darker" id="email" type="email" placeholder="email" name="email">
                @error('email')
